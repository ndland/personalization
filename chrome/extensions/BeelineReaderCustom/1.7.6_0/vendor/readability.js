...
/*
 * Edited by BeeLine Reader to:
 * - add readability.done for detecting when all pages are loaded
 * - remove the articleTools
 * - modify the articleFooter
 * - add #ifdef around readability.js
 * - underline links in the CSS
 * - modified fixImageFloats to always center images.
 * - do not remove BeeLine Reader scripts.
 * - include the 'beeline-region' class on #readInner.
*/
  ...
  **/
  var readability = {
      ...
      init: function() {
          ...
          innerDiv.className    = "beeline-region" + " " + readMargin + " " + readSize;
          ...
          **/
          ...
          if (nextPageLink) {
            ...
            dbg("No next page found.");
            readability.done = true;
          }
      ...
      **/
      ...
      getArticleFooter: function () {
          ...
          "<div id='rdb-footer-print' data-beeline-skip='true'>Excerpted from <cite>" + document.title + "</cite><br />" + window.location.href + "</div>",
          "<div id='rdb-footer-wrapper'>",
            "<div>",
              " <span id='beeline-attribution' data-beeline-skip='true'>",
                'Text extraction based on <a href="http://lab.arc90.com/experiments/readability" target="_blank">Readability</a> from Arc90 Labs, licensed under the <a href="http://www.apache.org/licenses/LICENSE-2.0.html" target="_blank">Apache License, Version 2</a>. ',
                'Gear icon is licensed under the ',
                '<a href="http://creativecommons.org/licenses/by-sa/3.0/" target="_blank">Creative Commons</a> license ',
                'from <a href="http://www.wpzoom.com" target="_blank">wpzoom.com</a>. ',
                'All other rights reserved; patents pending. ',
                'This extension is made available as a beta product and is a work in progress. ',
                'Please send us your feedback (bug fixes, new color scheme requests, etc.) via <a href="https://twitter.com/BeeLineReader" target="_blank">Twitter</a>, <a href="https://www.facebook.com/BeeLineReader" target="_blank">Facebook</a>, or <a target="_blank" href="mailto:nick@beelinereader.com?subject=Chrome feedback">email</a>!',
              "</span>",
            "</div>",
          "</div>"].join('');
      ...
      **/
      removeScripts: function (doc) {
          ...
          for(var i = scripts.length-1; i >= 0; i-=1)
          {
              ...
              {
                if (!scripts[i].getAttribute('data-readability-skip')) { // BeeLine Addition
                  scripts[i].nodeValue="";
